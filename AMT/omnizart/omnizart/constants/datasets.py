...
class GukakStructure(BaseStructure):
    """Structure of Korean traditional music dataset"""

    #: Label extension
    label_ext = ".mid"

    #: Folder to train wavs
    train_wavs = ["train_dataset/wav"]

    #: Folder to test wavs
    test_wavs = ["test_dataset/wav"]

    #: Folder to train labels
    train_labels = ["train_dataset/mid"]

    #: Folder to test labels
    test_labels = ["test_dataset/mid"]