...
class GukakLabelExtraction(BaseLabelExtraction):
    """Label extraction class for kor traditional music dataset"""
    @classmethod
    def load_label(cls, label_path):
        return dset.GukakStructure.load_label(label_path)
